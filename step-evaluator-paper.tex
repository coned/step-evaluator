...
%% Title information
\title{An Interactive Stepper for Expression with Holes}         %% [Short Title] is optional;
...
\author{Yanjun Chen} %%TODO:student number
 \authornote{Research advisor: Cyrus Omar; Category: undergraduate}          %% \authornote is optional;
                                        %% can be repeated if necessary
